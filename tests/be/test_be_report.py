...
def test_report_basic(get_be_baseurl, get_be_apikey, get_case_uuid):
...
def test_report_notexistuuid(get_be_baseurl, get_be_apikey):
...
def test_report_nolesionname(get_be_baseurl, get_be_apikey, get_case_uuid):
...
def test_report_invalidlesionname(get_be_baseurl, get_be_apikey, get_case_uuid):
